...
function App() {
  ...
  const handleGenerate = async () => {
    ...
    // Detect whether we are running in production or locally
    const API_URL =
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(
          errorData.detail ||
            "Failed to generate image. Please check your prompt or API status.",
        );
      }
  ...
  return (
    <div className="container">
      <header>
        ...
        <p>
          Transform your imagination into breathtaking visuals with the power of
          gpt-image-1.
        </p>
      </header>
          ...
          {loading && (
            <div className="loading-state">
              ...
              <p className="loading-text">
                gpt-image-1 is bringing your prompt to life...
              </p>
            </div>
          )}
